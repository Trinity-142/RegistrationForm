...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        MainWindow->resize(561, 291);
        QIcon icon;
        icon.addFile(QString::fromUtf8("../build-sign_in-Desktop_Qt_5_14_2_MinGW_32_bit-Debug/clipboard.ico"), QSize(), QIcon::Normal, QIcon::Off);
    ...
    void retranslateUi(QMainWindow *MainWindow)
    {
        ...
        label->setText(QCoreApplication::translate("MainWindow", "Emaill", nullptr));
